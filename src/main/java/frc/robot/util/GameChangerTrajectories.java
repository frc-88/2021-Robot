...
public class GameChangerTrajectories {
    ...
    private Trajectory generateBounce2Trajectory() {
        ...
        waypoints.add(new Pose2d(Units.feetToMeters(7.5), Units.feetToMeters(12.5), Rotation2d.fromDegrees(90.0)));
        // bounce
        waypoints.add(new Pose2d(Units.feetToMeters(9.5), Units.feetToMeters(7.5), Rotation2d.fromDegrees(120.0)));
        waypoints.add(new Pose2d(Units.feetToMeters(12.5), Units.feetToMeters(2.5), Rotation2d.fromDegrees(175.0)));
        // end at second star
        waypoints.add(new Pose2d(Units.feetToMeters(15.5), Units.feetToMeters(7.0), Rotation2d.fromDegrees(-95.0)));
        waypoints.add(new Pose2d(Units.feetToMeters(15.5), Units.feetToMeters(12.5), Rotation2d.fromDegrees(-90.0)));
    ...
    private Trajectory generateBounce3Trajectory() {
        ...
        waypoints.add(new Pose2d(Units.feetToMeters(15.5), Units.feetToMeters(12.5), Rotation2d.fromDegrees(-90.0)));
        // bounce
        waypoints.add(new Pose2d(Units.feetToMeters(19.0), Units.feetToMeters(2.5), Rotation2d.fromDegrees(0.0)));
        // end at third star
        waypoints.add(new Pose2d(Units.feetToMeters(23.5), Units.feetToMeters(10.0), Rotation2d.fromDegrees(90.0)));
        waypoints.add(new Pose2d(Units.feetToMeters(23.5), Units.feetToMeters(12.5), Rotation2d.fromDegrees(90.0)));
    ...
    private Trajectory generateBounce4Trajectory() {
        ...
        waypoints.add(new Pose2d(Units.feetToMeters(23.2), Units.feetToMeters(11.0), Rotation2d.fromDegrees(110.0)));
        waypoints.add(new Pose2d(Units.feetToMeters(30.0), Units.feetToMeters(8.5), Rotation2d.fromDegrees(180.0)));
    ...
    private Trajectory generateGSARedTrajectory() {
        ...
        var waypoints = new ArrayList<Translation2d>();
        // 1 Power cell
        waypoints.add(new Translation2d(Units.feetToMeters(7.5), Units.feetToMeters(6.7)));
        // 2 Power cell
        //waypoints.add(new Translation2d(Units.feetToMeters(7.5), Units.feetToMeters(5.5)));
        waypoints.add(new Translation2d(Units.feetToMeters(8.5), Units.feetToMeters(5.0)));
        waypoints.add(new Translation2d(Units.feetToMeters(10.5), Units.feetToMeters(2.5)));
        waypoints.add(new Translation2d(Units.feetToMeters(12.5), Units.feetToMeters(2.5)));
        waypoints.add(new Translation2d(Units.feetToMeters(13.5), Units.feetToMeters(5.2)));
        // 3 Power cells!
        waypoints.add(new Translation2d(Units.feetToMeters(14.5), Units.feetToMeters(12.0)));

        // ending pose, well past finish line, all the way into the finish zone
        Pose2d end = new Pose2d(Units.feetToMeters(30), Units.feetToMeters(9.5), Rotation2d.fromDegrees(180));
        // generate trajectory
        m_config.setReversed(true);
    ...
    private Trajectory generateGSABlueTrajectory() {
        ...
        var waypoints = new ArrayList<Translation2d>();
        // 1 Power cell
        waypoints.add(new Translation2d(Units.feetToMeters(10.0), Units.feetToMeters(3.5)));
