...
public class GameChangerTrajectories {
    ...
    private Trajectory generateGSARedTrajectory() {
        ...
        var waypoints = new ArrayList<Translation2d>();
        // 1 Power cell
//        waypoints.add(new Translation2d(Units.feetToMeters(7.5), Units.feetToMeters(8.0)));
        // 2 Power cell
        waypoints.add(new Translation2d(Units.feetToMeters(7.5), Units.feetToMeters(6)));
        waypoints.add(new Translation2d(Units.feetToMeters(12.5), Units.feetToMeters(4)));
        // 3 Power cells!
        waypoints.add(new Translation2d(Units.feetToMeters(14.5), Units.feetToMeters(11.2)));

        // ending pose, well past finish line, all the way into the finish zone
        Pose2d end = new Pose2d(Units.feetToMeters(30), Units.feetToMeters(9.0), Rotation2d.fromDegrees(180));
        // generate trajectory
        m_config.setReversed(true);
